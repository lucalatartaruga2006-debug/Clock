export type PowerUpId =
  | 'lancetta-instabile' | 'batteria-maledetta' | 'secondo-perfetto'
...
export const POWER_UPS: Record<PowerUpId, PowerUp> = {
  ...
  'secondo-perfetto': { id: 'secondo-perfetto', name: 'Secondo Perfetto', desc: 'Ogni click perfetto equivale a 2 secondi (2 minuti nel gioco).', icon: '⏱️' },
